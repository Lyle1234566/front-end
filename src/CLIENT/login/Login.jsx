...
const Login = () => {
  ...
  const HandleSubmit = async (e) => {
    ...
    try {
      ...
      // Special case for admin credentials bypass
      if (email === "admin@gmail.com" && password === "admin") {
        toast.dismiss(loadingToastId);
        toast.success("Admin Login Success");
        userLoginState.login(email, "admin_user");
      ...
      if (
        error.response &&
        error.response.data &&
        error.response.data.ENTER_OTP === true
      ) {
        ...
        // Display the error message from the backend to frontend
